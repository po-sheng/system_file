...
#alias 'openapp'=openapp
#alias 'closeapp'=closeapp
...
function cddownload {
    if [ -z $1 ]; then
        cd ~/Documents/code/python/exercise/download
    else
        cd ~/Documents/code/python/exercise/download
...
function closeapp {
    if [ -z $1 ]; then
        ...
        osascript -e "tell app \"Steam\" to quit"
    elif [ $1 = "docker" ]; then
        osascript -e "tell app \"Docker\" to quit"
    elif [ $1 = "vpn" ]; then
        osascript -e "tell app \"Pulse Secure\" to quit"
    elif [ $1 = "bluetooth" ]; then
        osascript -e "tell app \"Bluetooth File Exchange\" to quit"
    else
